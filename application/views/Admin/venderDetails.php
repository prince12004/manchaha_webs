                            ...
                            <div class="card-details ps-4 p-3">
                                <div class="content">
                                    ...
                                    <div class="d-flex justify-content-start gap-5">
                                        ...
                                        <ul>
                                            <li>
                                                <h6>Company Name:</h6> <span id="companyName">Type Company name</span>
                                            </li>
                                            <li>
                ...
                <div class="row g-3">
                    <div class="col-12 ">
                        <div style="bottom: -50px;"
                            class="table-header d-flex justify-content-between align-items-center ms-4">
...
$(document).ready(function() {
    const distributorListTable = $('#vendor-customer-Table').DataTable({
        ...
        "initComplete": function(settings, json) {
            $('#vendor-customer-Table_filter input').attr('placeholder',
