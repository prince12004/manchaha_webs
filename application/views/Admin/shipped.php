...
<div class="content">
    ...
    <div class="main-name-page">
        ...
        <div class="pages-buttons">
            ...
            <a href="<?= base_url('shipped/1')?>" class="page-tab active" id="shippedTab">
                Shipped
                    ...
                    <div class="order-history-paging" style="display: flex; justify-content: end;">
                        <ul class="page" style="display: flex; list-style: none; gap: 14px; margin: 19px 0px; cursor: pointer; font-size: 18px; align-items: center;">
                            ...
                            <li class="page__btn <?php if($orders['meta']['pagination']['current_page'] == 1) echo 'disabled'; ?>"
                                ...
                                onclick="window.location.href='<?= base_url('shipped/' . ($orders['meta']['pagination']['current_page'] - 1)) ?>'">
                            ...
                            <?php 
                                ...
                                for ($i = $startPage; $i <= $endPage; $i++) {
                                    ...
                                    echo "<li class='page__numbers $activeClass' onclick=\"window.location.href='" . base_url('shipped/' . $i) . "'\" data-page='$i'>$i</li>";
                                }
                                if ($endPage < $orders['meta']['pagination']['total_pages']) {
                                    echo "<li class='page__dots'>...</li>";
                                    echo "<li class='page__numbers' onclick=\"window.location.href='" . base_url('shipped/' . $orders['meta']['pagination']['total_pages']) . "'\" data-page='{$orders['meta']['pagination']['total_pages']}'>{$orders['meta']['pagination']['total_pages']}</li>";
                                }
                                ?>
