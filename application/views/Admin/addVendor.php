...
<div class="add-vendor-page content">
    <div class="content">
        ...
        <div class="vendor-details-cont my-2 mx-2">
            <div class="  d-flex flex-column">
                    ...
                    <div class="profile-card ">
                        <div class="d-flex flex-row">
                            <div class="profile-img">
                                ...
                                <img src="<?=base_url('/assets/images/image-uploader.png')?>" id="uploadIcon"
                                    alt="icon">
                                ...
                                <div class="content">
                                    ...
                                    <div class="d-flex justify-content-start gap-5">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <h6>Pen Card Number:</h6> <span id="pencardNumber">KXWPS7314B</span>
                                            </li>
                                            <li>
                ...
                <div class=" form-section w-100" data-tab="1">
                    <form>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control text-only" id="vendorName"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control email" id="vendorEmail"
                                    placeholder="abc@gmail.com" required>
                                <small class="error-message emailError"></small>
                            </div>
                            <div class="col-md-6">
                                <label for="phoneNumber" class="form-label">Phone Number</label>
                                <input type="text" class="form-control numbers-only phone" id="phoneNumber"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="panCardNumber" placeholder="DX123MV456"
                                    required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control text-only" id="city" placeholder="Noida"
                                    required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="aboutUs" rows="3"
                    ...
                    <!-- <div class="form-section w-100 mt-2 d-flex justify-content-between align-items-center gap-3" >  
                            ...
                            <div class="deactivate-section w-50">
                                ...
                                <label class="mb-2">Warning: Lorem Ipsum is simply dummy text of the printing typesetting industry.</label>
                    ...
                    <form>
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control text-only" id="name-bank"
                                    placeholder="Enter your name" required>
                            </div>
                            <div class="col-md-6">
                                <label for="email-bank" class="form-label">Account Email</label>
                                <input type="email" class="form-control email" id="email-bank"
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control numbers-only" id="account-number"
                            ...
                            <div class="col-md-6">
                                ...
                                <span id="account-error-message" class="error-message"
                                    style="display: none; color: red; font-size: 0.9rem;">Account Number does not
                                    match!</span>
                ...
                <div class="form-section" data-tab="3">
                    <form>
                        ...
                        <div class="d-flex gap-2 justify-content-center align-items-center">
                            <div class="col-md-6">
                                <label class="mb-2">
                                    Warning: Lorem Ipsum is simply dummy text of the printing typesetting industry.Lorem
                        ...
                        <div class=" container-A my-3">
                            ...
                            <div class="dropdown-card">
                                <div class="dropdown-card-header" data-bs-toggle="collapse" data-bs-target="#dropdown1">
                                    <div class="d-flex align-items-center">
                                        <h5 class="dropdown-heading">Lorem ipsum dolor sit amet consectetur, adipisicing
                                            elit.
                                        </h5>
                                    </div>
                                ...
                                <div id="dropdown1" class="collapse dropdown-card-body">
                                    <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor
                                        quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae
                                        numquam facere amet natus repellendus placeat sunt libero autem? </p>
                                </div>
                            </div>
                            <!-- Dropdown 2 -->
                            <div class="dropdown-card">
                                ...
                                <div id="dropdown2" class="collapse dropdown-card-body">
                                    <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor
                                        quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae
                                        numquam facere amet natus repellendus placeat sunt libero autem? al.
                                    </p>
                                </div>
                            </div>
                            <!-- Dropdown 3 -->
                            ...
                            <div class="dropdown-card">
                                ...
                                <div id="dropdown4" class="collapse dropdown-card-body">
                                    <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor
                                        quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae
                                        numquam facere amet natus repellendus placeat sunt libero autem? ed memories.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-section" data-tab="5">
                    <form>
                        ...
                        <!-- Add your form fields here -->
                        <div class="mb-3">
                            <label for="email-notifications" class="form-label">Recieve important updates and
                                notification on Email</label>
                            <div class="d-flex align-items-top gap-2">
                                ...
                                <button class="btn-success btn"><img
                                        src="<?= base_url('/assets/images/white-tick.png') ?>"
