                            ...
                            <div class="card-details ps-4 p-3">
                                <div class="content">
                                    ...
                                    <div class="d-flex justify-content-start gap-5">
                                        ...
                                        <ul>
                                            <li>
                                                <h6>Company Name:</h6> <span id="companyName">Company Name.</span>
                                            </li>
                                            <li>
                ...
                <div class=" form-section w-100" data-tab="1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="vendorcompanyName"
                                    placeholder="Simply Dummy Text" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                    ...
                    <div class="form-section w-100 mt-2 d-flex justify-content-between align-items-center gap-3">
                        <form class="w-50" id="passwordForm">
                            ...
                            <div class="password-section">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <button type="button" class="toggle-password"
                                        onclick="toggleVisibility('current-password')">
                            ...
                            <div class="password-section">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <button type="button" class="toggle-password"
                                        onclick="toggleVisibility('new-password')">
                                        <i class="eye-icon"><span class="material-symbols-outlined">
                                                visibility
                                            </span></i>
                                    </button>
                            ...
                            <div class="password-section">
                                ...
                                <span id="password-error-message" class="error-message"
                                    style="display: none; color: red; font-size: 0.9rem;">Passwords do not match!</span>
                            </div>
                            <div class="buttons">
                                <button type="submit" class="btn btn-primary  ms-2" id="save-changes">Save
                                    Changes</button>
                        ...
                        <div class="deactivate-section w-50">
                            ...
                            <textarea class="form-control w-100 mb-2" id="deactivate-reason"
                                placeholder="Enter Reason to Deactivate Account" rows="3"></textarea>
