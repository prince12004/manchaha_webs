        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="section container  mb-3">
                    ...
                    <input type="text" name="publish_date" id="Publish-Schedule"
                        value="<?= set_value('publish_date') ?>" class="form-input" required>
            ...
            <div class="col-md-8">
                <div class="section container  mb-3">
                    ...
                    <input type="text" id="product-name" name="product_name" value="<?= set_value('product_name') ?>"
                        class="form-control" placeholder="Type Product Name here..." required>
                    ...
                    <textarea id="product-description" name="product_description"
                        value="<?= set_value('product_description') ?>" class="form-control" rows="3"
                    ...
                    <div class="product-discription-cont">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input id="material-type" name="material_type" value="<?= set_value('material_type') ?>"
                                    type="text" class="form-input " placeholder="Crystal" required>
                            </div>
                            <div class="col-6">
                                <label for="metal Type" class="form-label">Metal Type</label>
                                <input id="metal-Type" name="metal_type" type="text"
                                    value="<?= set_value('metal_type') ?>" class="form-input " placeholder="Silver"
                                    required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input id="gem-Type" name="gem_type" value="<?= set_value('gem_type') ?>" type="text"
                                    class="form-input" placeholder="Crystal" required>
                            </div>
                            <div class="col-6">
                                <label for="Occasion Type" class="form-label">Occasion Type</label>
                                <input id="Occasion-Type" name="occation_type" value="<?= set_value('occation_type') ?>"
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input id="Ideal-For" name="ideal_for" type="text" value="<?= set_value('ideal_for') ?>"
                                    class="form-input " placeholder="Women" required>
                            </div>
                            <div class="col-6">
                                <label for="Sizing" class="form-label">Sizing </label>
                                <input id="Product-Sizing" name="sizing" type="text" value="<?= set_value('sizing') ?>"
                                    class="form-input" placeholder="Adjustable" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <label for="finish" class="form-label">Finish</label>
                                <input id="product-Finish" name="product_finish" type="text"
                                    value="<?= set_value('product_finish') ?>" class="form-input text-only"
                                    placeholder="Glossy" required>
                            </div>
                            <div class="col-6">
                                <label for="Generic Name" class="form-label">Generic Name</label>
                                <input id="Generic-Name" name="generic_name" value="<?= set_value('generic_name') ?>"
                                    type="text" class="form-input text-only" placeholder="Bracelets" required>
                            </div>
                            <div>
                                <label for="tax" class="form-label">Tax</label>
                                <input id="product-Finish" name="tax" type="text"
                                    value="<?= set_value('tax') ?>" class="form-input"
                ...
                <div class="section container mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <input type="text" class="form-input numbers-only" name="policy_time"
                ...
                <div class="section container mb-3">
                    ...
                    <div id="variants-container">
                        <div class="variant-section mb-3 mt-5">
                            <div class="variants-new d-flex align-items-center mb-3">
                                <div class="product-container-3">
                                    <div class="custom-file-input-container"
                                        style="position: absolute; top: -35px; left: 20px; background-color: #3182ce; color: white; padding: 5px 20px; border-radius: 5px;font-size:13px; width:150px">
                                        <input type="file" class="preview-input" name="images[0][]" accept="image/*"
                                            multiple id="fileInput" style="display: none;">
                                        <label for="fileInput"
                                            class="d-flex justify-content-center preview-input-btn">*Upload
                                            Images</label>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            ...
                                            <input type="text" name="dimension[]" class="form-input"
                                                placeholder="23 x 3 x 2 Centimeters">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="var_sku[]" class="form-input" placeholder="sku"
                                                required>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="hsn" class="form-label">*HSN Number</label>
                                            <input type="text" name="hsn[]" class="form-input" placeholder="HSN"
                                                required>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="Weight" class="form-label">Weight:</label>
                                            <input type="text" name="weight[]" class="form-input numbers-only"
                                                placeholder="20 g" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="Stock" class="form-label">*Stock</label>
                                            <input type="text" name="stock[]" class="form-input numbers-only"
                                                placeholder="256" required>
                                        </div>
                                        <div class="col-5">
                                            <label for="Product Base Price" class="form-label">*Product MRP
                                                :</label>
                                            <input type="text" name="base_price[]" class="form-input numbers-only"
                                                placeholder="Type MRP" required>
                                        </div>
                                        <div class="col-5">
                                            <label for="Sale Price" class="form-label">*Sale Price:</label>
                                            <input type="text" name="sale_price[]" class="form-input numbers-only"
                                                placeholder="Type sale price" required oninput="validatePrices()">
                                            <p id="price-error" style="color: red; display: none;"><small>Product Base
                                                    Price should be less than or equal to the Sale Price.</small></p>
                                        </div>
                                        <div class="col-4">
            ...
            <div class="d-flex gap-5 form-action-btn justify-content-center mb-5 mt-4">
                ...
                <button type="button" class="btn btn-light d-flex align-items-center me-4"><span
                        class="material-symbols-outlined">
                        cancel
...
document.getElementById('add-variant-btn').addEventListener('click', function(event) {
    ...
    let isValid = true;
    if (!imageInput.files.length || !colorInput.value.trim() || !stockInput.value.trim() || !skuInput.value
        .trim() || !basePriceInput.value.trim() || !salePriceInput.value.trim()) {
        isValid = false;
    }
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="details">
                    <div class="row">
                        ...
                        <div class="col-5">
                            <label for="Product Base Price" class="form-label">*Product MRP :</label>
    ...
    function validatePrices() {
        ...
        variantSections.forEach(section => {
            ...
            if (basePrice < salePrice) {
                error.style.display = "block"; // Show error if base price is less than sale price
            } else {
                error.style.display =
                "none"; // Hide error if base price is equal to or greater than sale price
            }
        });
    }
...
<div class="content-img">
    <img src="https://via.placeholder.com/400x300" alt="Reviews Image">
</div>
