...
<div class="login-container">
    ...
    <div class="form-sectionss p-5">
        ...
        <h4>We will send you a one-time password to this Phone No.</h4>
        <form id="loginForm">
            <label for="mobile">Phone No.</label>
            <input type="number" id="mobile" name="mobile" placeholder="Enter Phone No."
                value="<?= set_value('mobile') ?>" autofocus>

            <button id="req-otp-btn" class="req-otp-btn" type="button" onclick="showModal() ">Request OTP</button>
            <p>Login Using Email <a href="<?= base_url('Welcome/loginpage')?>">Click Here</a></p>
        </form>
