                                ...
                                <div class="card-details ps-4 p-3">
                                   ...
                                   <h2 id="profileName">Enter profile name</h2>
                                    ...
                                    <div class="d-flex justify-content-start gap-5">
                                        ...
                                        <ul>
                                            <li><h6>Company Name:</h6> <span id="companyName"> Enter Company name</span></li>
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control text-only" id="vendorName" placeholder="Enter name" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="companyName" class="form-label">Company Name</label>
                                    <input type="text" class="form-control" id="vendorcompanyName" placeholder="Enter company name" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="aboutUs" rows="3" placeholder="Something about you..."></textarea>
                            </div>
                    ...
                    <div class="form-section" data-tab="3">
                        <form>
                            ...
                            <div class="d-flex gap-2 justify-content-center align-items-center" >
                                <div class="col-md-6">
                                    <label class="mb-2">
                                    Warning: Lorem Ipsum is simply dummy text of the printing typesetting industry.Lorem Ipsum has been the industry's standard dummy text ever since
                                    </label>
                                    <div class="col-md-11">
                            ...
                            <div class=" container-A my-3">
                                ...
                                <div class="dropdown-card">
                                    ...
                                    <div id="dropdown1" class="collapse dropdown-card-body">
                                        <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae numquam facere amet natus repellendus placeat sunt libero autem? </p>
                                    </div>
                                </div>
                                <!-- Dropdown 2 -->
                                <div class="dropdown-card">
                                    <div class="dropdown-card-header" data-bs-toggle="collapse" data-bs-target="#dropdown2">
                                        <div class="d-flex align-items-center"> 
                                            <h5 class="dropdown-heading">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h5>
                                        </div>
                                        <span class="dropdown-toggle-icon">+</span>
                                    </div>
                                    <div id="dropdown2" class="collapse dropdown-card-body">
                                        <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae numquam facere amet natus repellendus placeat sunt libero autem? al.
                                        </p>
                                    </div>
                                </div>
                                <!-- Dropdown 3 -->
                                ...
                                <div class="dropdown-card">
                                    ...
                                    <div id="dropdown4" class="collapse dropdown-card-body">
                                        <p class="para-A">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor quis perspiciatis hic non laudantium atque vel illum, a nisi consequuntur, quae numquam facere amet natus repellendus placeat sunt libero autem? ed memories.</p>
                                    </div>
                                </div>
                            </div>   
                        </form>
