            ...
            <div class="table-header d-flex justify-content-between align-items-center ms-4">
                ...
                <div class="d-flex g-2 align-items-center">
                    <a href="<?= base_url('Web/Admin/Admin/subCategory') ?>">
                        <button class="btn btn-primary px-5 d-flex align-items-center"><span class="material-symbols-outlined">
                            add_circle
                      ...
                      <form action="">
                        <div class="card p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="categoryName" name="categoryname" value="<?= set_value('categoryname')?>" placeholder="Enter Category Name">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="categorydescription" value="<?= set_value('description')?>" id="description" rows="4" placeholder="Type Product Description here..."></textarea>
                            </div>
                            ...
                            <!-- Save Button -->
                            <div class="d-grid">
                                <button type="button" onclick="saveCategory('<?= $cat['CategoryID']?>')" class="btn btn-primary btn-lg">Save Now</button>
                            </div>
                        </div>
                      </form>
                    </div>
                        ...
                        <div class="pb-2" style="overflow-x: scroll;">
                            ...
                            <table  id="category-detail-Table" class=" table hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="d-flex justify-content-start align-items-center gap-2"><img class="product-image" style="height: 50px;" src="<?= base_url('uploads/').$category['categoryImage']?>" alt="User Image"><?= $category['CategoryName']?></td>
                                        ...
                                        <td><div class="action-icons">
                                            <a href="#" class="icon view-icon" title="view"><img src="<?= base_url('assets/images/eye.png') ?>" alt="view" width="20px"></a>
                                            <button onclick="deletecategory('<?= $category['CategoryID']?>')" class="icon hand-icon" title="delete"><img src="<?= base_url('assets/images/Trash.png') ?>" alt="Handle" width="20px"></button>
                                        </div></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
...
function deletecategory(id) {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { id: id }, // Send ID as an object
