            ...
            <div class="stat-box-row g-1 col-12 mb-3 d-flex ">
                <div class="cards ">
                    <div class="stat-box p-3 text-center bg-light rounded">
                        <h3>Total Sales</h3>
                        <p>₹ 0</p>
                        <span class="percent-stat d-flex gap-2"><span class="green d-flex align-items-center">1.23%</span> Super Admin</span>
                    </div>
                </div>
                <div class="cards ">
                    <div class="stat-box p-3 text-center bg-light rounded">
                        <h3>Recent Orders</h3>
                        <p>₹ 0</p>
                        <span class="percent-stat d-flex gap-2"><span class="green d-flex align-items-center">5.20%</span> Super Admin</span>
                    </div>
                </div>
                <div class="cards ">
                    <div class="stat-box p-3 text-center bg-light rounded">
                        <h3>Orders Paid</h3>
                        <p>₹ 0</p>
                        <span class="percent-stat d-flex gap-2"><span class="red d-flex align-items-center">3.35%</span> Super Admin</span>
                    </div>
                </div>
                <div class="cards ">
                    <div class="stat-box p-3 text-center bg-light rounded">
                ...
                <div class="cards ">
                    <div class="stat-box p-3 text-center bg-light rounded">
                        <h3>Average Sales</h3>
                        <p>₹ 0</p>
                        <span class="percent-stat d-flex gap-2"><span class="red d-flex align-items-center">1.23%</span> Super Admin</span>
                    </div>
                </div>
            </div>
            <div class="row g-3">
