<?php $this->load->view('User/header')?>
 <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet" />
  ...
  <style>
     .navbar, .header-main,.newsLetter-section,.footer-section,#profile-menu{
      display:none;
    }
  ...
  background: transparent;
    ...
    <div class="login-container" style="width: 50%; padding: 20px;">
		<form class="login100-form" action="<?php echo base_url('Welcome/admin_login'); ?>" id="login-form"  method="POST" >
                    ...
                    <a href="#"><img src="http://mnnchaha.com/assets/images/logo.png" alt="logo" /></a>
						<span class="login100-form-title my-3 p-b-26">
						 Login
					</span>
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input class="input100" id="password-field" type="password" name="password"   placeholder="Password"  maxlength="50" >
