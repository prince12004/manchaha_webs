<?php $this->load->View('Admin/header') ?>
        <div class=" mt-2">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex">
                    <button type="button" class="btn btn-dark me-2 d-flex align-items-center"><span class="material-symbols-outlined">
                        check_circle
                        </span>Save Now</button>
                    <button type="button" class="btn btn-light d-flex align-items-center"><span class="material-symbols-outlined">
                        cancel
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="section container  mb-3">
                        ...
                        <textarea id="product-description" class="form-control" rows="3" placeholder="Type Product Description here..."></textarea>
                    </div>
                    <div class="section container mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div id="product-sections-2">
                                <div class="product-container-2">
                                    ...
                                    <div class="details">
                                        <input type="text" class="form-input mb-1" placeholder="Type Title Heading here...">
                                        <textarea id="product-description" class="form-control" rows="3" placeholder="Type Product Specification here..."></textarea>
                                    </div>
                                </div>
                            </div>
                       </div>
                    ...
                    <div class="section container mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                         ...
                         <button class="product-info-btn d-flex justify-content-center gap-1 align-items-center"><span class="material-symbols-outlined">
                             add_circle
                        ...
                        <div class="d-flex gap-1  flex-wrap " id="product-sections-3">
                            <div class=" mb-3 section-cloned-3">
                                <div class="product-container-3">
                                    ...
                                    <input type="file" id="image-upload" class="image-upload" accept="image/*" style="display: none;" multiple>
