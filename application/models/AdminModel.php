...
{
    return $this->db->select('jwellaries.*, jwellary_varient.*, jwellary_images.image,categories.CategoryName')
                    ->from('jwellaries')
                    ...
                    ->join('categories', 'jwellaries.category_id = categories.CategoryID')
                    ->get()
                    ->row_array();
}
